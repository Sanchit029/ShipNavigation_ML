...
def draw_quit_button(screen):
    """
    Draw a quit button in the top-right corner of the screen.
    
    :param screen: Pygame screen surface
    :return: Pygame Rect representing the quit button
    """
    # Screen dimensions
    ...
    # Button colors
    button_color = (200, 50, 50)  # Reddish color
    ...
    # Render text
    font = pygame.font.Font(None, 36)
    text_surface = font.render('Quit', True, text_color)
